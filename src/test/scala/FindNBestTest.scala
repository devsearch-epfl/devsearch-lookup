...
class FindNBestTest extends FlatSpec with Matchers {
  ...
  it should "return results sorted" in {
    ...
    FindNBest(input, int2float, 5) shouldEqual List(5,4,3,2,1)
  }
}
