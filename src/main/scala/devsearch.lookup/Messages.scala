...
case class SearchResultEntry(user: String, repo: String, path: String, lineStart: Int, lineEnd: Int, score: Float, scoreBreakDown: Map[String, Double], featureList: Set[String])
